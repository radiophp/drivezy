...
const AddNettoInvoice = () => {
    const { t, lang } = useTranslation('common');
    const [addNettoInvoice,{ isLoading: creationLoading }] = useAddNettoInvoiceMutation();
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const result = await addNettoInvoice({
                car: carId,
                customer: customerId,
                price: amount,
                user: userData._id,
            ...
            console.error('Failed to add Netto invoice:', error);
        }
    };
                    ...
                    <Grid item xs={12}>
                        ...
                        >
                            {creationLoading ?
                                ...
                                t('invoice.add_netto_invoice') // Show text otherwise
                            }
                        </Button>
                    </Grid>
...
export default AddNettoInvoice;
