...
const AddDfzInvoice = () => {
    ...
    const [addDfzInvoice,{ isLoading: creationLoading }] = useAddDfzInvoiceMutation();
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const result = await addDfzInvoice({
                car: carId,
                customer: customerId,
                price: amount,  // Here
                user: userData._id,
            ...
            console.error('Failed to add DFZ invoice:', error);
        }
    };
                    ...
                    <Grid item xs={12}>
                        ...
                        >
                            {creationLoading ?
                                ...
                                t('invoice.add_dfz_invoice') // Show text otherwise
                            }
                        </Button>
                    </Grid>
