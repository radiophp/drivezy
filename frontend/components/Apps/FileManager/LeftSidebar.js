    ...
    <>
      ...
      >
        ...
        <ul className={styles.leftNav}>
          ...
          >
            <Link href="/admash/apps/file-manager">
            ...
            <ul>
              ...
              >
                <Link href="/admash/apps/file-manager/assets">Assets</Link>
              </li>
              ...
              >
                <Link href="/admash/apps/file-manager/projects">Projects</Link>
              </li>
              ...
              >
                <Link href="/admash/apps/file-manager/personal">Personal</Link>
              </li>
              ...
              >
                <Link href="/admash/apps/file-manager/templates">Templates</Link>
              </li>
            </ul>
          </li>
          ...
          >
            <Link href="/admash/apps/file-manager/documents">
          ...
          >
            <Link href="/admash/apps/file-manager/media">
          ...
          >
            <Link href="/admash/apps/file-manager/recents">
          ...
          >
            <Link href="/admash/apps/file-manager/important">
          ...
          >
            <Link href="/admash/apps/file-manager/trash">
